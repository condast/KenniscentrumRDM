package org.rdm.kc.sensornet.gps;

import org.rdm.kc.sensornet.utils.StringStyler;
...
public class WayPoint implements Comparable<WayPoint>{
	...
	public String printStructure(int tabs) {
		...
		buffer.append( Attributes.LONGTITUDE.toString() + ": " + this.getLongtitude()+ "\n");
		printTabs( buffer, tabs+1 );
		buffer.append( Attributes.LATITUDE.toString() + ": " + this.getLatitude()+ "\n");
