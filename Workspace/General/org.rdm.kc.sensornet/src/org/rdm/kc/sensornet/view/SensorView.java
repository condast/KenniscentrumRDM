package org.rdm.kc.sensornet.view;
...
import org.rdm.authentication.RdmLoginBean;
...
import org.rdm.kc.sensornet.echosounder.garmin.BathymetryComposite;
import org.rdm.kc.sensornet.turbility.TurbilityComposite;
import org.rdm.kc.sensornet.utils.ImageResources;
import org.rdm.kc.sensornet.utils.ImageResources.Images;

public class SensorView extends Composite {
	...
	public static final String S_ECHOBEAM = "Echo Sounder";
	 ...
	 * @param style
	 */
	public SensorView(Composite parent, int style) {
		super(parent, style);
	...
	public void createComposite( Composite parent, int style ){
		...
		tabFolder.setEnabled( true/*login.isLoggedin()*/ );
		
		CTabItem tbtmRoute_1 = new CTabItem(tabFolder, SWT.NONE);
		tabFolder.setData( RWT.CUSTOM_VARIANT, S_TRAJECTORY_ITEM );
		tbtmRoute_1.setText( S_ECHOBEAM );

		final BathymetryComposite composite_route = new BathymetryComposite(tabFolder, SWT.NONE);
		...
		Composite boatComposite = new TurbilityComposite(tabFolder, SWT.NONE);
