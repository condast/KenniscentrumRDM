...
public class ProjectFolderUtils {
	...
	public static final String S_STORE_CACHE = "cache";
	 ...
	 * @return
	 */
	public static URI getStoreDir( String folder )
	{
	 ...
	 * @return 
	 */
	public static URI getDefaultStoreDir( String folder, String name )
	{
	 ...
	 * @return 
	 */
	public static URI getDefaultConfigDir( String folder, String name )
	{
		File file = new File( System.getProperty( S_USER_HOME_PROPERTY ) + File.separator + 
				folder + File.separator + StringStyler.prettyString( name ) + File.separator + S_STORE_CACHE);
		return file.toURI();
	}
